...
public class GravityControllerTest
{
    ...
    void updateForce()
    {
        ...
        GravityController controller = new GravityController(gravityComponent, xField, yField, timeFeild, angleLabel, magnitudeLabel, apexLabel);
